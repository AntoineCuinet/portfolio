...
'<footer>',
    '<div class="footer-container">',
        ...
        '<div class="bloc">',
            '<h3>Réseaux</h3>',
            '<ul>',
                '<li><a class="footer-links" href="https://linkedin.com/in/antoine-cuinet" target="_blank">LinkedIn</a></li>',
                '<li><a class="footer-links" href="https://github.com/AntoineCuinet" target="_blank">GitHub</a></li>',
            '</ul>',
        '</div>',
    '</div>',
